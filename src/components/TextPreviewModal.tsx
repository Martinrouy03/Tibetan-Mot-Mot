    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-features">
          <div className="modal-feature-group">
            <span className="modal-feature-group-label">Support de récitation</span>
            <div className="modal-feature-group-cells">
          ...
          <div className="modal-feature-group">
            <span className="modal-feature-group-label">Supports de visualisation</span>
            <div className="modal-feature-group-cells">
              <div className={`modal-feature ${hasImages ? 'feature-yes' : 'feature-no'}`}>
                ...
                <span>Images</span>
                <span className="feature-value">{hasImages ? `${imageCount}` : 'Non'}</span>
              </div>
              <div className={`modal-feature ${hasVideo ? 'feature-yes' : 'feature-no'}`}>
                <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor">
