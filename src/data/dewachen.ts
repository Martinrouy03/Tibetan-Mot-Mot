      ...
      phrases: [
        {
          id: "dw-instr-1",
          type: "instructions",
          tibetan: "༄༅། །བསྔོ་རྟེན་ཕུལ་བའི་གཤིན་དོན་ལ།",
          phonetics: "",
          translation: "Pour les défunts :",
          words: [],
        },
        {
          id: "dw-1",
          type: "normal",
          tibetan: "མདུན་མཁར་སངས་རྒྱས་འོད་དཔག་མེད།",
          phonetics: "dun k'ar / sangyé / eu pak mé",
          translation:
            "Dans l'espace devant soi, se trouvent le Bouddha Amitabha",
          words: [
            {
              tibetan: "མདུན་མཁར་",
              phonetics: "dun k'ar",
              translation: "dans l'espace devant soi",
            },
            {
              tibetan: "སངས་རྒྱས་",
              phonetics: "sangyé",
              translation: "le Bouddha",
            },
            {
              tibetan: "འོད་དཔག་མེད་",
              phonetics: "eu pak mé",
          ...
          words: [
            {
              tibetan: "གཙོ་འཁོར་",
              phonetics: "tso k'or",
              translation: "et son entourage",
            },
            {
              tibetan: "ཐུགས་ཀའི་",
              phonetics: "t'ouk ké",
              translation: "de leur cœur",
            },
            {
        ...
        },
        {
          ...
          words: [
            ...
            },
            {
              tibetan: "གཙོར་བྱས་",
              phonetics: "tsor djé",
              translation: "à leur attention",
            },
            {
              tibetan: "བར་དོ་ཡི་",
              phonetics: "bar do yi",
              translation: "du bardo",
            },
          ],
        },
        {
          ...
          words: [
            ...
            },
            {
              tibetan: "བསྡུས་ཤིང་",
              phonetics: "du ching",
              translation: "rassemblés",
            },
            { tibetan: "སྡིག་", phonetics: "dik", translation: "négativités" },
            { tibetan: "སྒྲིབ་", phonetics: "drip", translation: "et voiles" },
            { tibetan: "སྦྱངས་", phonetics: "djang", translation: "purifient" },
          ],
        },
        {
          id: "dw-5",
        ...
        },
        {
          ...
          words: [
            {
              tibetan: "བདེ་བ་ཅན་དུ་",
              phonetics: "déwatchen tou",
              translation: "en Dewachen",
            },
            { tibetan: "ཁྲིད་", phonetics: "t'i", translation: "conduits" },
            {
              tibetan: "མཛད་ནས་",
              phonetics: "dzé né",
              translation: "après avoir",
            },
          ],
        },
        {
          ...
          words: [
            { tibetan: "ཕྱིར་མི་", phonetics: "tchir mi", translation: "non-" },
            {
              tibetan: "ལྡོག་པའི་",
              phonetics: "dok pé",
              translation: "retour",
            ...
            {
              tibetan: "འཁོད་གྱུར་",
              phonetics: "k'eu gyour",
              translation: "ils s'établissent",
            },
          ],
        },
      ],
    },
    {
      ...
      phrases: [
        ...
        },
        {
          ...
          phonetics: "mik yul / ngen song / douk ngel / mi nyong ching",
          translation:
            "Puissent [les personnes] objets de votre attention, sans avoir à endurer les souffrances des mondes inférieurs,",
          words: [
            {
              tibetan: "དམིགས་ཡུལ་",
              phonetics: "mik yul",
            ...
            },
            {
              tibetan: "ངན་སོང་",
              phonetics: "ngen song",
              translation: "des mondes inférieurs",
            },
            {
              tibetan: "སྡུག་བསྔལ་",
              phonetics: "douk ngel",
            ...
            {
              tibetan: "མི་མྱོང་ཞིང་",
              phonetics: "mi nyong ching",
              translation: "sans avoir à endurer",
            },
          ],
        },
        {
        ...
        },
        {
          id: "dw-22",
          type: "normal",
          tibetan: "ལྷ་བས་ལྷག་པའི་ལུས་ཐོབ་ནས།",
          phonetics: "lha wé / lhak pé / lu t'op né",
          translation: "Ayant obtenu un corps supérieur à celui d'un dieu,",
          words: [
            {
              tibetan: "ལྷ་བས་",
              phonetics: "lha wé",
              translation: "à celui d'un dieu",
            },
            {
              tibetan: "ལྷག་པའི་",
              phonetics: "lhak pé",
            ...
            {
              tibetan: "ལུས་ཐོབ་ནས་",
              phonetics: "lu t'op né",
              translation: "ayant obtenu un corps",
            },
          ],
        },
        {
          ...
          words: [
            { tibetan: "དེ་དག་", phonetics: "té tak", translation: "ils" },
            {
              tibetan: "སངས་རྒྱས་",
              phonetics: "sangyé",
        ...
        },
        {
          ...
          targetId: "/text/pratique-chenrezik#ch-prieres-lv",
          altTargetId: "/text/pratique-chenrezik-thoungma#ch-colophon",
