...
**Vérifier la correspondance grammaticale entre le tibétain et les mots de la traduction.** La traduction de phrase fournie est souvent fluide (niveau phrase entière) mais peut masquer des décalages au niveau mot à mot — par exemple un adverbe en français ("prématurément") qui devrait être un adjectif ("prématurée") au niveau du mot tibétain. Quand la correspondance demande à être précisée (accord, nature grammaticale, sens littéral vs sens de la phrase), le signaler et demander à l'utilisateur quelle formulation il préfère.

**Ne jamais modifier les groupes phonétiques fournis sans validation.** Les groupes définis par `/` dans les phonétiques sont la référence pour le découpage `words`. Si les groupes ne permettent pas de faire une correspondance claire avec la traduction, signaler le problème et demander comment regrouper. **Exception : si un groupe coupe une frontière grammaticale tibétaine évidente** (ex : particule ablative ལས་ collée à la syllabe suivante alors qu'elle clôt la proposition précédente ; composé verbal tibétain scindé en deux groupes, ex : བྱིན་གྱིས་བརླབ་ coupé en བྱིན་གྱིས་ / བརླབ་), proposer un regroupement plus pertinent avec explication avant d'insérer — l'utilisateur valide ou corrige.
